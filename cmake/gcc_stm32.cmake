...
FUNCTION(STM32_FIND_COMPONENTS SEARCH_PATH FILE_PATTERN COMPONENT_REGEX COMPONENTS_VAR_NAME)
    ...
    #    MESSAGE(STATUS "FILE_PATTERN: ${FILE_PATTERN}")
    #    MESSAGE(STATUS "COMPONENT_REGEX: ${COMPONENT_REGEX}")
    #    MESSAGE(STATUS "COMPONENTS_VAR_NAME: ${COMPONENTS_VAR_NAME}")
...
FUNCTION(STM32_ADD_TARGET_COMPILE_DEFINITION TARGET DEF_NAME)
    GET_TARGET_PROPERTY(TARGET_DEFS ${TARGET} COMPILE_DEFINITIONS)
    IF(TARGET_DEFS)
        SET(TARGET_DEFS "${DEF_NAME};${TARGET_DEFS}")
    ELSE()
        SET(TARGET_DEFS "${DEF_NAME}")
    ENDIF()
    MESSAGE(STATUS "TARGET_DEFS: ${TARGET_DEFS}")
    SET_TARGET_PROPERTIES(${TARGET} PROPERTIES COMPILE_DEFINITIONS "${TARGET_DEFS}")
ENDFUNCTION()

FUNCTION(STM32_ENABLE_HAL_COMPONENT TARGET COMPONENT_LIST)

    MESSAGE(STATUS "STM32_ENABLE_HAL_COMPONENT:TARGET: ${TARGET}")
    MESSAGE(STATUS "STM32_ENABLE_HAL_COMPONENT:COMPONENT_LIST: ${COMPONENT_LIST}")
    MESSAGE(STATUS "STM32_ENABLE_HAL_COMPONENT:ARGC: ${ARGC}")

    MATH(EXPR ARGV_RANGE "${ARGC} - 1")
    FOREACH (vari RANGE 1 ${ARGV_RANGE})
        STRING(TOUPPER ${ARGV${vari}} COMPONENT_NAME_UPPER)
        MESSAGE(STATUS "STM32_ENABLE_HAL_COMPONENT:COMPILE_DEFINITION HAL_${COMPONENT_NAME_UPPER}_MODULE_ENABLED")

        STM32_ADD_TARGET_COMPILE_DEFINITION(
                ${TARGET}
                "HAL_${COMPONENT_NAME_UPPER}_MODULE_ENABLED"
                ON)
    ENDFOREACH ()
ENDFUNCTION()
