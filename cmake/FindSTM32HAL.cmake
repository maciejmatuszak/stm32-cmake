...
STM32_FIND_COMPONENTS(${STM32Cube_DIR}/Drivers/STM32${STM32_FAMILY}xx_HAL_Driver/Src "*.c" "${HAL_PREFIX}hal_([a-z0-9]+).c" HAL_COMPONENTS)
STM32_FIND_COMPONENTS(${STM32Cube_DIR}/Drivers/STM32${STM32_FAMILY}xx_HAL_Driver/Src "*.c" "${HAL_PREFIX}hal_([a-z0-9]+)_ex.c" HAL_EX_COMPONENTS)
MESSAGE(STATUS "DISCOVERED Hardware Abstraction Layer (HAL) drivers components: ${HAL_COMPONENTS}")
MESSAGE(STATUS "DISCOVERED Hardware Abstraction Layer (HAL) extension drivers components: ${HAL_EX_COMPONENTS}")
...
FOREACH(cmp ${STM32HAL_FIND_COMPONENTS})
    ...
    IF(NOT (${STM32HAL_FOUND_INDEX} LESS 0))
        MESSAGE(STATUS "COMPONENT: ${cmp} - adding: ${HAL_PREFIX}hal_${cmp}_ex.c")
