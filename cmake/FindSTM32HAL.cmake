...
STM32_FIND_COMPONENTS(${STM32HAL_INCLUDE_DIR}/../Src "*.c" "${HAL_PREFIX}hal_([a-z0-9]+)_ex.c" HAL_EX_COMPONENTS)
STM32_FIND_COMPONENTS(${STM32HAL_INCLUDE_DIR}/../Src "*.c" "${HAL_PREFIX}hal_([a-z0-9]+).c" HAL_COMPONENTS)
