...
STM32_FIND_COMPONENTS(${STM32Cube_DIR}/Drivers/STM32${STM32_FAMILY}xx_HAL_Driver/Inc "*.h" "${HAL_PREFIX}ll_([a-z0-9]+).h" LL_COMPONENTS)
MESSAGE(STATUS "DISCOVERED Low Level drivers components: ${LL_COMPONENTS}")
